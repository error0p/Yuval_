      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', marginBottom: '5rem' }}>
          <div className="glass-card" style={{ padding: '2.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 500, marginBottom: '1rem', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Not Fabricators. Solutions.</h3>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', lineHeight: '1.6', fontWeight: 300 }}>
          ...
          <div className="glass-card" style={{ padding: '2.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 500, marginBottom: '1rem', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Uncompromising Quality</h3>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', lineHeight: '1.6', fontWeight: 300 }}>
          ...
          <div className="glass-card" style={{ padding: '2.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 500, marginBottom: '1rem', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Precision Installation</h3>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', lineHeight: '1.6', fontWeight: 300 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '4rem', marginBottom: '5rem' }}>
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1.2rem', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
              <li style={{ display: 'flex', gap: '1rem' }}>
                <strong style={{ color: 'var(--text-primary)', minWidth: '110px' }}>Residential:</strong>
                <span>Luxury penthouses, villas, apartment complexes, renovation projects, and designer collaborations.</span>
              </li>
              <li style={{ display: 'flex', gap: '1rem' }}>
                <strong style={{ color: 'var(--text-primary)', minWidth: '110px' }}>Commercial:</strong>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.6', marginBottom: '1rem', fontWeight: 300 }}>
