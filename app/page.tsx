...
export default function Home() {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <section id="products" className="section" style={{ position: 'relative', zIndex: 5, backgroundColor: 'var(--bg-secondary)' }}>
              ...
              <div className="flex flex-col space-y-4">
                {SLIDES.map((slide, index) => (
                  <TextStaggerHover
                    key={slide.id}
                    index={index}
                    className="cursor-pointer text-4xl lg:text-5xl font-bold uppercase tracking-tighter text-[var(--text-primary)]"
                    text={slide.title}
                  />
                ))}
              </div>
      ...
      <section className="section" style={{ backgroundColor: 'var(--bg-primary)', position: 'relative', zIndex: 5 }}>
        <div className="container">
          ...
          <div className="projects-grid">
            <div className="glass-card" style={{ overflow: 'hidden' }}>
              ...
              <div style={{ padding: '2rem' }}>
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 500, margin: '0.5rem 0 1rem 0', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Luxury Penthouse Apartment</h3>
            ...
            <div className="glass-card" style={{ overflow: 'hidden' }}>
              ...
              <div style={{ padding: '2rem' }}>
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 500, margin: '0.5rem 0 1rem 0', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Himalayan Boutique Resort</h3>
                <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
            ...
            <div className="glass-card" style={{ overflow: 'hidden' }}>
              ...
              <div style={{ padding: '2rem' }}>
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 500, margin: '0.5rem 0 1rem 0', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>Modern Tea Estate Villa</h3>
                <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
      ...
      <section className="section" style={{ backgroundColor: 'var(--bg-secondary)', borderTop: '1px solid var(--border-light)', position: 'relative', zIndex: 5 }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.7', marginBottom: '2.5rem', fontWeight: 300 }}>
          ...
          <div style={{
            ...
            <svg viewBox="0 0 100 100" style={{ width: '100%', height: 'auto', display: 'block' }}>
              <path d="M 0 10 L 100 10 M 0 30 L 100 30 M 0 50 L 100 50 M 0 70 L 100 70 M 0 90 L 100 90 M 10 0 L 10 100 M 30 0 L 30 100 M 50 0 L 50 100 M 70 0 L 70 100 M 90 0 L 90 100" stroke="rgba(0,0,0,0.03)" strokeWidth="0.2"/>
              <path d="M 10 40 L 25 20 L 40 35 L 55 10 L 70 30 L 85 15 L 95 35" fill="none" stroke="rgba(0,0,0,0.04)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
              <circle cx="50" cy="25" r="2.5" fill="var(--accent)" stroke="var(--bg-primary)" strokeWidth="0.5" />
              <circle cx="45" cy="65" r="2.5" fill="var(--accent)" stroke="var(--bg-primary)" strokeWidth="0.5" />
              <circle cx="30" cy="45" r="2.5" fill="var(--text-muted)" stroke="var(--bg-primary)" strokeWidth="0.5" />
              <circle cx="70" cy="70" r="2.5" fill="var(--text-muted)" stroke="var(--bg-primary)" strokeWidth="0.5" />
              <text x="50" y="21" textAnchor="middle" fill="var(--text-secondary)" fontSize="3.5" fontFamily="var(--font-sans)">Gangtok</text>
              <text x="45" y="73" textAnchor="middle" fill="var(--text-secondary)" fontSize="3.5" fontFamily="var(--font-sans)">Siliguri</text>
            </svg>
          </div>
        </div>
      </section>
      ...
      {/* 5. GENERAL CTA */}
      <section className="section" style={{ backgroundColor: 'var(--bg-primary)', textAlign: 'center', borderTop: '1px solid var(--border-light)', position: 'relative', zIndex: 5 }}>
        <div className="container" style={{ maxWidth: '600px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '3rem', fontSize: '1rem', lineHeight: '1.6', fontWeight: 300 }}>
